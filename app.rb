...
class App
  ...
  def create_student
    ...
    @people << student
    puts 'Student was created sucessfully'
  end
  ...
  def create_teacher
    ...
    @people << teacher
    puts 'Teacher was created sucessfully'
  end
  ...
  def add_book
    ...
    @books << book
    puts 'Book was created sucessfully'
  end
  ...
  def add_rental
    ...
    rental = Rental.new(@books[book_idx], @people[person_idx], rental_date)
    @rentals << rental
